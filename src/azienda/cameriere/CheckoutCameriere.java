 ...
 */
@WebServlet({ "/CheckoutCameriere", "/checkoutcameriere"})
public class CheckoutCameriere extends CameriereHome {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
		if(checkSession(request, response)) {	
			String address = "/WEB-INF/azienda/cameriere/checkoutCameriere.jsp";
