...
<div class="container">
    ...
    <div class="jumbotron">
        <h1>Spiaggia</h1>
        <p>Prenota le tue postazioni o delle sdraio da mettere in battigia. Seleziona le postazioni che desideri, comprensive ciascuna di un ombrellone e due sdraio. Possiamo anche aggiungere altre sdraio da mettere vicino la postazione, nei limiti dello spazio a disposizione, o in battigia. </p>
    </div>
    ...
    <form id="formConferma" action="Spiaggia" method="post">
        ...
        <br />
            <div class="form-group">
                <label for="sdraio">Sdraio aggiuntive:</label>
